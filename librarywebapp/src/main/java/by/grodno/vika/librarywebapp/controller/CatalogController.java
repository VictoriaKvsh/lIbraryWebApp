...
public class CatalogController {
	...
	@GetMapping("/catalog/{pageNum}")
	public String getCatalog(Model model, @PathVariable(name = "pageNum") Integer pageNum,  @RequestParam(required = false, name = "sortField") String sortField)  {
